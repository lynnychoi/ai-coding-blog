...
### 최종 결과물 스크린샷
폴더: `scratch-notes/ai-coding-blog/screenshots/2026-03-23-typography/`

- `01-home.png` — 홈페이지 전체
- `02-dev-post-full.png` — dev 타입 글 전체 (Playwright 포스트, Figtree 폰트, mint 색상, `// ---` HR)
- `03-dev-post-top.png` — dev 타입 글 상단 (제목, H2, blockquote)
- `04-writing-post-top.png` — writing 타입 글 상단 (Gowun Dodum 폰트, gradient H1, `· · ·` HR)
- `05-writing-post-full.png` — writing 타입 글 전체
- `06-about.png` — About 페이지 (post-body 클래스 적용, blockquote 스타일 통일)

> 글 쓸 때 더 필요하면 추가로 찍을 것: H2 클로즈업, takeaway-box 클로즈업, dark/light 모드 비교, 모바일 뷰
